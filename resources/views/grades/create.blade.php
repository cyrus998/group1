            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        ...
                        <strong>Grade created successfully</strong>
                    </div>
                    ...
                    <div class="card border-0">
                        <div class="card-body">
                            <h4 class="card-title text-center mt-3"><strong>GRADE RECORDS</strong></h4>
                            <p class="card-text">Please fill out the form to add a new Grades.</p>
                            <form method="post" action="{{route('grades.store')}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control shadow-none @error('prelim') is-invalid @enderror" name="prelim" id="prelim" value="{{old('prelim')}}">
                                    @error('prelim')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control shadow-none @error('midterm') is-invalid @enderror" name="midterm" id="midterm" value="{{old('midterm')}}">
                                    @error('midterm')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control shadow-none @error('final') is-invalid @enderror" name="final" id="final" value="{{old('final')}}">
                                    @error('final')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
