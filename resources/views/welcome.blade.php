...
<head>
    ...
    <title>Grading System Welcome</title>
    ...
    <section class="relative">
        ...
        <div class="relative max-w-screen-xl px-4 py-32 mx-auto lg:h-screen lg:items-center lg:flex">
            <div class="max-w-xl text-center sm:text-left">
                ...
                <h1 class="p-2 font-extrabold text-8xl sm:text-8xl bg-gradient-to-tl from-rose-200 via-sky-400 to-indigo-700 bg-clip-text text-transparent">EDEN</h1><br>
                <h1 class="p-2 font-extrabold text-6xl sm:text-8xl bg-gradient-to-tl from-rose-200 via-sky-400 to-indigo-700 bg-clip-text text-transparent">Academy</h1>


                <p class="p-2 mt-16 font-bold max-w-lg sm:leading-relaxed sm:text-2xl text-white">
                    Eden Academy's Grading System.
                </p>
...
<style>
    html {
        background-image: url('https://cdn.discordapp.com/attachments/971130306751000636/980780977150361611/unknown.png');
        height: 100%;
