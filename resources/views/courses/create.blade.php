            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="card border-0">
                        <div class="card-body">
                            <h4 class="card-title text-center mt-3"><strong>COURSE INFORMATION</strong></h4>
                            <p class="card-text">Please fill out the form to add a new Course.</p>
                            <form method="post" action="{{route('courses.store')}}">
                                @csrf
                                <div class="mb-3">
                                    <label for="courseCode" class="form-label">Course Code</label>
                                    <input type="text" class="form-control shadow-none @error('courseCode') is-invalid @enderror" name="courseCode" id="courseCode" value="{{old('courseCode')}}">
                                    @error('courseCode')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control shadow-none @error('courseTitle') is-invalid @enderror" name="courseTitle" id="courseTitle" value="{{old('courseTitle')}}">
                                    @error('courseTitle')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
